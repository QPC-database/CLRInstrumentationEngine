...
namespace CommonLib
{
    ...
    public:
        ...
        bool ToString(_Inout_ std::string& converted);
        ...
        /// <param name="converted">The converted string</param>
        /// <returns>true for success, false otherwise.</returns>
        bool ToString(_Inout_ tstring& convertetd);
        ...
        static bool FromString(_In_ const tstring& origninal, _Inout_ SystemString& result);
        ...
        /// <param name="result">The local OS string</param>
        /// <returns>true for success, false otherwise</return>
        static bool FromString(_In_ const WCHAR* lpzwStr, _Inout_ SystemString& result);
        ...
        /// <param name="result">The local OS string</param>
        /// <returns>true for success, false otherwise</return>
        static bool FromString(_In_ const CHAR* lpzStr, _Inout_ SystemString& result);
    };
